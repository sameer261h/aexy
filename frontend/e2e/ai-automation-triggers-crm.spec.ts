/**
 * E2E: All CRM trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in CRM's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["crm"]).
