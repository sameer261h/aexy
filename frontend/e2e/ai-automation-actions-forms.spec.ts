/**
 * E2E: All forms action subtypes — palette → canvas → persistence.
 *
 * Parametrized over every action available to the forms module: the
 * common bucket (send_email, send_slack, webhook_call, …) PLUS the
 * forms-specific bucket (create_record, update_record, enroll_sequence, …).
 ...
 *
 * Per subtype:
 *   1. Open a fresh canvas filtered to the forms module
