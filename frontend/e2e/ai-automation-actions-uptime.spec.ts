/**
 * E2E: All uptime action subtypes — palette → canvas → persistence.
 *
 * Parametrized over every action available to the uptime module: the
 * common bucket (send_email, send_slack, webhook_call, …) PLUS the
 * uptime-specific bucket (create_record, update_record, enroll_sequence, …).
