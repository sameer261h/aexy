/**
 * E2E: All forms trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in forms's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["forms"]).
