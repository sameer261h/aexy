/**
 * E2E: All booking trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in booking's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["booking"]).
