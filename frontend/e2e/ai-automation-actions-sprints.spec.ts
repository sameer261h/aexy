/**
 * E2E: All sprints action subtypes — palette → canvas → persistence.
 *
 * Parametrized over every action available to the sprints module: the
 * common bucket (send_email, send_slack, webhook_call, …) PLUS the
 * sprints-specific bucket (create_record, update_record, enroll_sequence, …).
 ...
 *
 * Per subtype:
 *   1. Open a fresh canvas filtered to the sprints module
