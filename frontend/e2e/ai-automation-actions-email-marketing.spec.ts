/**
 * E2E: All email_marketing action subtypes — palette → canvas → persistence.
 *
 * Parametrized over every action available to the email_marketing module: the
 * common bucket (send_email, send_slack, webhook_call, …) PLUS the
 * email_marketing-specific bucket (create_record, update_record, enroll_sequence, …).
 ...
 *
 * Per subtype:
 *   1. Open a fresh canvas filtered to the email_marketing module
