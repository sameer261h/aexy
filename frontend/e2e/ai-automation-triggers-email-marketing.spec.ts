/**
 * E2E: All email_marketing trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in email_marketing's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["email_marketing"]).
