/**
 * E2E: All sprints trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in sprints's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["sprints"]).
