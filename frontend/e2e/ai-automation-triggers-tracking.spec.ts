/**
 * E2E: All tracking trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in tracking's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["tracking"]).
