/**
 * E2E: All hiring trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in hiring's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["hiring"]).
