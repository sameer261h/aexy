/**
 * E2E: All tickets trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in tickets's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["tickets"]).
