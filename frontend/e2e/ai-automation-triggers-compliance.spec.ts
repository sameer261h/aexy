/**
 * E2E: All compliance trigger subtypes — palette → canvas → persistence.
 *
 * Parametrized over every trigger in compliance's registry entry
 * (backend/src/aexy/schemas/automation.py::TRIGGER_REGISTRY["compliance"]).
