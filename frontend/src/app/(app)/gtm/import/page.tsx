          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 text-zinc-300 hover:bg-white/10 rounded-lg text-xs font-medium transition-colors border border-white/10"
              >
            ...
            <textarea
              ...
              rows={10}
              className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-zinc-600 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500/50 resize-y"
            />
            {csvContent && (
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <div>
                  <div className="text-sm text-white">Verify Emails</div>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <div>
                  <div className="text-sm text-white">Skip Duplicates</div>
                  <div className="text-xs text-zinc-500">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-black/30 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 appearance-none"
                >
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden">
            ...
            {result.rows.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-zinc-400">No rows processed</p>
              </div>
            )}
          </div>
