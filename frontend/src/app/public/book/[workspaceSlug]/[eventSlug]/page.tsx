...
export default function PublicBookingPage() {
  ...
  const loadEventType = async () => {
    try {
      const data = await publicBookingApi.getEventType(workspaceSlug, eventSlug);
      setEventType(data);
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await publicBookingApi.createBooking(workspaceSlug, eventSlug, {
