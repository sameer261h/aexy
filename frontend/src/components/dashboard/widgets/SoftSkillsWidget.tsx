  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        <div className="p-1.5 bg-gradient-to-br from-cyan-500/20 to-teal-500/20 rounded-lg shrink-0">
          ...
          <div className="bg-card border border-border rounded-xl overflow-hidden">
            <div className="px-4 py-3 border-b border-border flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <h3 className="text-sm font-semibold text-foreground truncate">My Goals</h3>
              </div>
              <Link href="/reviews/goals" className="text-cyan-400 hover:text-cyan-300 text-xs flex items-center gap-0.5 transition whitespace-nowrap shrink-0">
          ...
          <div className="bg-card border border-border rounded-xl overflow-hidden">
            <div className="px-4 py-3 border-b border-border flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <h3 className="text-sm font-semibold text-foreground truncate">Performance Reviews</h3>
              </div>
              <Link href="/reviews" className="text-teal-400 hover:text-teal-300 text-xs flex items-center gap-0.5 transition whitespace-nowrap shrink-0">
                View all <ChevronRight className="w-4 h-4" />
              </Link>
            </div>
