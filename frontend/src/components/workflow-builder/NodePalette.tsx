...
const TRIGGER_LABELS: Record<string, Record<string, string>> = {
  ...
  uptime: {
    ...
    "monitor.ssl_expiring": "SSL Expiring",
    "monitor.repeated_failures": "Repeated Failures",
  ...
  sprints: {
    ...
    "sprint.velocity_calculated": "Velocity Calculated",
    "sprint.burndown_off_track": "Burndown Off Track",
...
const TRIGGER_DESCRIPTIONS: Record<string, Record<string, string>> = {
  ...
  tickets: {
    ...
    "ticket.reopened": "When a resolved or closed ticket is reopened",
  ...
  uptime: {
    ...
    "monitor.ssl_expiring": "When an SSL certificate is within 30 days of expiration",
    "monitor.repeated_failures": "When a monitor has 3+ consecutive check failures",
  ...
  sprints: {
    ...
    "sprint.velocity_calculated": "When sprint velocity is calculated after completion",
    "sprint.burndown_off_track": "When burndown deviates 20%+ from the ideal line",
