...
const nodeCategories: NodeCategory[] = [
  ...
  },
  {
    ...
    subtypes: [
      ...
      { value: "api_request", label: "API Request", icon: Webhook },
      ...
      { value: "link_records", label: "Link Records", icon: Database },
      { value: "enrich_record", label: "Enrich Record", icon: Sparkles },
      { value: "classify_record", label: "Classify Record", icon: Target },
      { value: "generate_summary", label: "Generate Summary", icon: FileText },
    ],
  },
  {
    type: "condition",
