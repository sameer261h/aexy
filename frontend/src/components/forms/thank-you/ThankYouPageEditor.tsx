    ...
    <div className="flex gap-6 h-full">
      ...
      <div className="flex-1 overflow-y-auto pr-4 space-y-6 pb-24">
        ...
        <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg border border-slate-700">
          <div>
            <h3 className="text-sm font-medium text-white">Use Form Theme</h3>
          ...
          <button
            ...
            className={`relative w-12 h-6 rounded-full transition-colors ${
              localConfig.use_form_theme !== false ? "bg-purple-600" : "bg-slate-600"
            }`}
          >
            <span
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-4">
            <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-slate-300">Show ticket number</span>
            </label>
          </div>
        ...
        <div className="space-y-3">
          ...
          {localConfig.content?.image?.url && (
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-400 mb-1.5">Alt Text</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1.5">Position</label>
                <select
