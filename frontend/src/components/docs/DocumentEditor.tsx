...
export function DocumentEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-invert max-w-none focus:outline-none min-h-[500px] px-4 py-2 prose-p:text-slate-200 prose-headings:text-white prose-strong:text-white prose-li:text-slate-200",
      },
    },
    onUpdate: ({ editor }) => {
