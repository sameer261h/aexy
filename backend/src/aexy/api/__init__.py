...
from aexy.api.csv_import import csv_import_router
...
api_router.include_router(csv_import_router, tags=["csv-import"], dependencies=[Depends(require_app_access("crm"))])
# Platform-wide Automations
